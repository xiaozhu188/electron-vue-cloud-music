    ...
    <ul class="events">
      <template v-for="(event, index) in events">
        <li
          :key="event.id"
          class="event"
          v-if="['song','video','playlist'].includes(Object.keys(event.json)[1])"
        >
          ...
          <div class="event-detail">
            ...
            <div
              class="event-info"
              :class="{'video':Object.keys(event.json)[1]==='video','song':Object.keys(event.json)[1]==='song','playlist':Object.keys(event.json)[1]==='playlist', 'zoom':event.currentIndex>=0 && event.currentIndex === currentIndex}"
            >
              <!-- <div>
...
import { getEvent, getUserEvent } from '@/api/user'
